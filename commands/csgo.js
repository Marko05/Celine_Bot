...
module.exports.run = async(bot, msg, args) => {
    ...
    if(!args[0]){
        return msg.channel.send("Please Enter a valid STEAMID64");
    }
    ...
    request(UR_L, function(err, resp, body){
        ...
        if(KD == -1){
            return msg.channel.send("Invalid, make sure your profile is not private and you have entered a valid STEAMID64!");
        }
